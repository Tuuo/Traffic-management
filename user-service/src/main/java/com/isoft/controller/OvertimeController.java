...
public class OvertimeController {
    ...
    @Resource
    private OvertimeService maintainService;

    @GetMapping("/list")
    public Result getList(OvertimeQueryVo groupQueryVo){
        //创建分页对象
        IPage<Overtime> page = new Page<Overtime>(groupQueryVo.getPageNo(), groupQueryVo.getPageSize());
        //调用分页查询方法
    ...
    @PostMapping("/add")
    public Result addGroup(@RequestBody Overtime group) {
    ...
    @PutMapping("/update")
    public Result updateGroup(@RequestBody Overtime group){

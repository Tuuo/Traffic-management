...
public class WorkController {
    ...
    @Resource
    private WorkService maintainService;

    @GetMapping("/list")
    public Result getList(WorkQueryVo groupQueryVo){
        //创建分页对象
        IPage<Work> page = new Page<Work>(groupQueryVo.getPageNo(), groupQueryVo.getPageSize());
        //调用分页查询方法
    ...
    @PostMapping("/add")
    public Result addGroup(@RequestBody Work group) {
    ...
    @PutMapping("/update")
    public Result updateGroup(@RequestBody Work group){

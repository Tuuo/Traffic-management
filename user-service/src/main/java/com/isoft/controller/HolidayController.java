...
public class HolidayController {
    ...
    @Resource
    private HolidayService maintainService;

    @GetMapping("/list")
    public Result getList(HolidayQueryVo groupQueryVo){
        //创建分页对象
        IPage<Holiday> page = new Page<Holiday>(groupQueryVo.getPageNo(), groupQueryVo.getPageSize());
        //调用分页查询方法
    ...
    @PostMapping("/add")
    public Result addGroup(@RequestBody Holiday group) {
    ...
    @PutMapping("/update")
    public Result updateGroup(@RequestBody Holiday group){
